    ...
    const PollModal = () => {
        ...
        if (isOpen)
            return (
                <section onClick={() => closeModal()} style = {{backdropFilter:"blur(5px)"}} className='w-full h-screen fixed top-0 left-0  bg-white/10 drop-shadow-xl  z-[100] grid place-items-center'>
